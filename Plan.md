  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <ul>
            UI:
            <li>На странице виден элемент с текстом "Ошибка"</li>
            <li>Поле "Номер карты" имеет значение "1111 2222 3333 4444"</li>
            <li>Остальные поля не имеют предупреждений</li>
        </ul>
        <ul>
            БД:
    ...
    <tr>
      ...
      <td>
        <ul>
            UI:
            <li>Поле "Номер карты" имеет значение "4444 4444 4444 444"</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            UI:
            <li>Поле "Месяц" имеет значение "00"</li>
            <li>На форме под полем "Месяц" видно предупреждение "Неверно указан срок действия карты"</li>
            <li>Остальные поля не имеют предупреждений</li>
        </ul>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            UI:
            <li>Поле "Месяц" имеет значение месяца первой карты</li>
            <li>На странице виден элемент с текстом "Успешно"</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            UI:
            <li>Поле "Месяц" имеет значение "0"</li>
            <li>На форме под полем "Месяц" видно предупреждение "Неверный формат"</li>
            <li>Остальные поля не имеют предупреждений</li>
        </ul>
        <ul>
    ...
    <tr>
      ...
      <td>
        <ul>
            UI:
            <li>Поле "Год" имеет значение "2"</li>
    ...
    <tr>
      ...
      <td>
        <ul>
            UI:
            <li>На странице виден элемент с текстом "Успешно"</li>
            <li>Поле "Год" имеет значение года первой карты</li>
            <li>Поля формы не имеют предупреждений</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            ...
            <li>Значение поля "Год" соответствует первым двум цифрам введённого года</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            UI:
            <li>На форме под полем "Год" видно предупреждение "Истёк срок действия карты"</li>
            <li>Значение поля "Год" соответствует первым двум цифрам введённого значения</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            ...
            <li>На форме видно предупреждение:
                <ul>
                    <li>"Истёк срок действия карты" под полем "Месяц", если в поле "Год" введён текущий год, а в поле "Месяц" введён номер месяца, меньше текущего</li>
                    <li>"Истёк срок действия карты" под полем "Год" и под полем "Месяц", если в поле "Год" введён год, меньше текущего</li>
                </ul>
            </li>
        </ul>
      </td>
    ...
    <tr>
      ...
      <td>
        <ul>
            UI:
            <li>Поле "CVC/CVV" имеет значение, соответсвующее первым трём введённым цифрам</li>
            <li>Остальные поля не имеют предупреждений</li>
        </ul>
      </td>
    </tr>
    <tr>
      ...
      <td>
        <ul>
            UI:
            <li>На форме под полем "CVC/CVV" видно предупреждение "Поле обязательно для заполнения"</li>
            <li>Поле "CVC/CVV" имеет значение "" (пустая строка)</li>
            <li>Остальные поля не имеют предупреждений</li>
        </ul>
      </td>
    </tr>
